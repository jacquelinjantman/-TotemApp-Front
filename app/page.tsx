  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-8 text-center max-w-xs w-full">
        ...
        <svg width="140" height="280" viewBox="0 0 140 280">
          ...
          <g style={style("0.85s")}>
            ...
            <path
              d="M70 162 C70 162 60 155 60 163 C60 168 70 174 70 174 C70 174 80 168 80 163 C80 155 70 162 70 162 Z"
              fill="#F43F5E"
            />
          </g>
      ...
      <p
        ...
        className="text-xs text-green-900 font-medium mt-2"
      >
        {" "}
        Desarrollado por Jacquelin Jantman
      </p>
    </main>
  );
}
